...
class boletosComponent extends Component
{
	...
	public $components = array(  'condominios',  'contas', 'parcelas');

	// ------------------- FUNÇÕES DO ARQUIVO funcoes_cef_sigcb.php ----------------------------  //
    ...
    public function fbarcode($valor){
        ...
        //Guarda inicial
        $return = '<img src="img/boleto/p.png" width="'.$fino.'" height="'.$altura.'" border="0"><img 
        src="img/boleto/b.png" width="'.$fino.'" height="'.$altura.'" border="0"><img 
        src="img/boleto/p.png" width="'.$fino.'" height="'.$altura.'" border="0"><img 
        src="img/boleto/b.png" width="'.$fino.'" height="'.$altura.'" border="0"><img 
        ';
        ...
        while (strlen($texto) > 0) {
          ...
          for($i=1;$i<11;$i+=2){
            ...
            $return .=' src="img/boleto/p.png" width="'.$f1.'" height="'.$altura.'" border="0"><img ';
            if (substr($f,$i,1) == "0") {
              $f2 = $fino ;
            }else{
              $f2 = $largo ;
            }
            $return .= 'src="img/boleto/b.png" width="'.$f2.'" height="'.$altura.'" border="0"><img ';
          }
        }

        return $return .= ' src="img/boleto/p.png" width="'.$largo.'" height="'.$altura.'" border="0"><img 
        src="img/boleto/b.png" width="'.$fino.'" height="'.$altura.'" border="0"><img 
        src="img/boleto/p.png" width="1" height="'.$altura.'" border="0">';
    } //Fim da função
