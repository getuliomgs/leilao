    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $lance->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $lance->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $lance->id], ['confirm' => __('Are you sure you want to delete # {0}?', $lance->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
