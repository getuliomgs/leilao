 ...
 *
 */
class APagarContasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tipo' => ['type' => 'string', 'fixed' => true, 'length' => 5, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'ContasAPagar_FKIndex1' => ['type' => 'index', 'columns' => ['extratos_id'], 'length' => []],
            'contas_a_pagar_FKIndex2' => ['type' => 'index', 'columns' => ['plano_contas_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'a_pagar_contas_ibfk_1' => ['type' => 'foreign', 'columns' => ['extratos_id'], 'references' => ['extratos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'a_pagar_contas_ibfk_2' => ['type' => 'foreign', 'columns' => ['plano_contas_id'], 'references' => ['plano_contas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'tipo' => 'Lor',
            'valor' => 1.5,
            'date_pagamento_previsto' => '2016-03-15',
            'date_pagamento_real' => '2016-03-15',
            'doc_referencia' => 'Lorem ipsum dolor sit amet',
            'created' => '2016-03-15 21:15:14',
            'modified' => '2016-03-15 21:15:14'
        ],
    ];
}
